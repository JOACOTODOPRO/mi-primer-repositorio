// Alumno: [Onetto Joaquin]
// Carrera: Programación Dispositivos Móviles - 2° Año
// Parcial 2 - ISFT N°220



"use strict";
// ARRAY DE PRUEBAS REDUCIDO PARA EL EXAMEN
const formulariosDePrueba = [
    {
        id: 1,
        nombre: "María García",
...
function validarFormulario(form) {
    ...
    if (telefonoLimpio === "") {
        ...
        const errorMsg = `La longitud neta debe ser entre 8 y 15 dígitos (Tiene: ${telefonoLimpio.length}).`;
        errores.push(errorMsg);
        console.log(`X Error en telefono: ${errorMsg}`);
    }
    else {
    ...
    if (mensajeTrim === "") {
        ...
        console.log("✔ Campo de mensaje válido");
    }
    // ==========================================
